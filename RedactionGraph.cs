...
namespace RedactionGraph
{
    ...
    {
        private const  int notInstalledConstrainMaxCountOfRedaction = -1;
        private const bool notAllowConstrainTwoRedactionAdjactive = true;
        public const bool PrintOnlyMinOfWithRedaction = true;
        public static int[,,] editorialDistance_;
        private static string possibleMisspletWord;
        ...
        private static bool isResolveFound = !true;
        public static bool caseSensitivity = true;

        public static bool isWordFounded() { return isResolveFound;}
        
        public static void ConstrainTwoRedactionAdjactiveOn()
        {
            constrainTwoRedactionAdjactive = notAllowConstrainTwoRedactionAdjactive;
        }
        public static void ConstrainTwoRedactionAdjactiveOff()
        {
            constrainTwoRedactionAdjactive = ! notAllowConstrainTwoRedactionAdjactive;
        }
        
        public static void PrintOnlyMinOfWithRedactionOn()
        {
            printOnlyMinOfWithRedaction = ! MethodLevenstain.PrintOnlyMinOfWithRedaction;
        }
          
        public static void NewSeek()
        {
          isResolveFound = false;
        }
        public static void PrintOnlyMinOfWithRedactionOff()
        {
            printOnlyMinOfWithRedaction = MethodLevenstain.PrintOnlyMinOfWithRedaction;
        }
        public static void SetPossibleMisspletWord(string source)
        {
            possibleMisspletWord = source;
        }
        
        public static void SetDictWord(string source)
        {
            dictWord = source;
        }
